...
BlueBark Lite is a low-latency Raspberry Pi 3 spectrum detector for fast TETRA-like burst activity. It is built around a NooElec NESDR V5, `rtl_power_fftw`, a Cython DSP bridge, an SSD1306 OLED, three membrane buttons, and an active buzzer.

This repository is provided as-is.

Important: this project is a signal presence and strength monitor only. It does not decode, demodulate, or reconstruct TETRA voice or data content.
...
MIT is a good default if you want people to be able to use the project freely while keeping attribution.
If you want a different license style, swap the `LICENSE` file before publishing.
